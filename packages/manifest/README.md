...
Shared element definition for the **Sequence** content element in [Tailor CMS](https://github.com/tailor-cms/author).
...
```sh
npm install @tailor-cms/ce-sequence-manifest
```
...
```ts
import manifest, { type ElementData } from '@tailor-cms/ce-sequence-manifest';

manifest.type;       // 'SEQUENCE'
